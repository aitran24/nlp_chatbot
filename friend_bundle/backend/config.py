...
EMBED_MODEL1 = os.getenv(
    "EMBED_MODEL1",
    "sentence-transformers/paraphrase-multilingual-mpnet-base-v2",
)

EMBED_MODEL2 = os.getenv(
    "EMBED_MODEL2",
    "BAAI/bge-m3",  # 1024 chiều, khớp với chatbot_documents
)
...
QDRANT_PATH = Path(os.getenv("QDRANT_PATH", str(WORKSPACE_ROOT / "friend_bundle/cache/qdrant_local_bench")))
QDRANT_COLLECTION = os.getenv("QDRANT_COLLECTION", "dut_chunks")
QDRANT_ADDITIONAL_COLLECTION = os.getenv("QDRANT_ADDITIONAL_COLLECTION", "chatbot_documents")
